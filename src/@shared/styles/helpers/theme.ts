...
export const darkTheme = {
  ...
  backgroundFloating: opacity(12, colors.black),
  backgroundOutline: opacity(24, colors.gray300),
  backgroundScrim: opacity(72, colors.gray900),
  backgroundScrolledSurface: opacity(72, colors.gray900),
  ...
  accentWarningSoft: opacity(24, colors.gold200),
  accentFailureSoft: opacity(12, colors.red300),

  accentTextDarkPrimary: opacity(80, colors.gray900),
  accentTextDarkSecondary: opacity(60, colors.gray900),
  accentTextDarkTertiary: opacity(24, colors.gray900),

  accentTextLightPrimary: colors.gray50,
  accentTextLightSecondary: opacity(72, colors.gray50),
  accentTextLightTertiary: opacity(12, colors.gray50),
  ...
  networkDefaultShadow: `0px 40px 120px ${opacity(16, colors.blue400)}`,
...
export const lightTheme: Theme = {
  ...
  backgroundInteractive: colors.gray150,
  backgroundFloating: opacity(8, colors.gray700),
  backgroundOutline: colors.gray150,
  backgroundScrim: opacity(60, colors.gray900),
  backgroundScrolledSurface: opacity(72, colors.white),
  ...
  accentActiveSoft: opacity(24, colors.blue400),
  accentSuccessSoft: opacity(24, colors.green300),
  accentWarningSoft: opacity(24, colors.gold400),
  accentFailureSoft: opacity(12, colors.red400),
  ...
  networkDefaultShadow: `0px 40px 120px ${opacity(12, colors.pink400)}`,
...
export type ThemeLightType = typeof lightTheme;
export type ThemeDarkType = typeof darkTheme;

declare module "@emotion/react" {
  export interface Theme extends ThemeLightType, ThemeDarkType {}
}
